<template>
   ...
   <van-nav-bar title="费用类型"  left-text="返回" left-arrow
...
<div class="side-right">
    <!-- {{curTypeList}} -->
    <!-- 42 -->
 <van-cell v-for="el in curTypeList" :key="el.id" is-link :title="el.fylxmc" />
</div>
    </div>
    </div>
</template>
...
.expense-type-container{
    ...
    .sklafjal{
        ...
        .side-right{
            width: calc(100vw - 100px);height:100%;overflow-y:auto;
            .van-cell__title{
                padding-left: 10px;
            }
        }
